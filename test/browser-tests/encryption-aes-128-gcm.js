...
describe('EncryptionAES128GCM', () => {
	...
	const VALID_SERVER_KEYS = {
		publicKey:
			'BG3OGHrl3YJ5PHpl0GSqtAAlUPnx1LvwQvFMIc68vhJU6nIkRzPEqtCduQz8wQj0r' +
			'71NVPzr7ZRk2f-fhsQ5pK8',
		...
		getKey: (keyId) => {
			...
			case 'p256dh':
				return base64UrlToUint8Array(
					'BCIWgsnyXDv1VkhqL2P7YRBvdeuDnlwAPT2guNhdIoW3IP7GmHh1SMKPLxRf' +
					'7x8vJy6ZFK3ol2ohgn_-0yP7QQA=',
				);
			case 'auth':
	...
	const VALID_OUTPUT = {
		...
		context:
			'UC0yNTYAAEEEIhaCyfJcO_VWSGovY_thEG9164OeXAA9PaC42F0ihbcg_saYeH' +
			'VIwo8vFF_vHy8nLpkUreiXaiGCf_7TI_tBAABBBG3OGHrl3YJ5PHpl0GSqtAAl' +
			'UPnx1LvwQvFMIc68vhJU6nIkRzPEqtCduQz8wQj0r71NVPzr7ZRk2f-fhsQ5pK8',
		cekInfo: 'Q29udGVudC1FbmNvZGluZzogYWVzMTI4Z2NtAA',
		nonceInfo: 'Q29udGVudC1FbmNvZGluZzogbm9uY2UA',
		keyInfo:
			'V2ViUHVzaDogaW5mbwAEIhaCyfJcO_VWSGovY_thEG9164OeXAA9PaC42F0ihbc' +
			'g_saYeHVIwo8vFF_vHy8nLpkUreiXaiGCf_7TI_tBAARtzhh65d2CeTx6ZdBkqr' +
			'QAJVD58dS78ELxTCHOvL4SVOpyJEczxKrQnbkM_MEI9K-9TVT86-2UZNn_n4bEOaSv',
		prk: 'YXQOi9WVYZRvGk9pdoq-u_zr15HGsuzU7sPVSTb70Xk',
		contentEncryptionKey: 'qIuzYacKKN1q4hIxqOCJrw',
		nonce: 'QvcILucv_Mh5t9ff',
		payload:
			'AAAAAAAAAAAAAAAAAAAAAAAAEABBBG3OGHrl3YJ5PHpl0GSqtAAlUPnx1LvwQvF' +
			'MIc68vhJU6nIkRzPEqtCduQz8wQj0r71NVPzr7ZRk2f-fhsQ5pK96Kh5TnTaUZZ' +
			'ypdS4uO2SzLwNL6N-KfyTk59Qu3hw',
	};

	const VALID_VAPID_KEYS = {
		publicKey:
			'BG3OGHrl3YJ5PHpl0GSqtAAlUPnx1LvwQvFMIc68vhJU6nIkRzPEqtCduQz8wQj0' +
			'r71NVPzr7ZRk2f-fhsQ5pK8',
		privateKey: 'Dt1CLgQlkiaA-tmCkATyKZeoF1-Gtw1-gdEP6pOCqj4',
	};
	...
	it('should generate key info', async () => {
		...
		const serverKeys = await encryptionHelper.getServerKeys();
		const keyInfo = await encryptionHelper._getKeyInfo(
			VALID_SUBSCRIPTION,
			serverKeys,
		);
