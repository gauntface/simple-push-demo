...
describe('VAPID 1', function() {
	const VALID_VAPID_KEYS = {
		publicKey:
			'BG3OGHrl3YJ5PHpl0GSqtAAlUPnx1LvwQvFMIc68vhJU6nIkRzPEqtCduQz8wQj0r71NV' +
			'Pzr7ZRk2f-fhsQ5pK8',
	...
	const VALID_OUTPUT = {
		...
		unsignedToken:
			'eyJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NiJ9.eyJhdWQiOiJodHRwczovL2ZjbS5nb29n' +
			'bGVhcGlzLmNvbSIsImV4cCI6MTQ2NDMyNjEwNiwic3ViIjoibWFpbHRvOnNpbXBsZS1wd' +
			'XNoLWRlbW9AZ2F1bnRmYWNlLmNvLnVrIn0',
		p256ecdsa:
			'BG3OGHrl3YJ5PHpl0GSqtAAlUPnx1LvwQvFMIc68vhJU6nIkRzPEqtCduQz8wQj0r71NV' +
			'Pzr7ZRk2f-fhsQ5pK8',
	};
	...
	it('should generate specific VAPID authentication headers', async () => {
		...
		authHeaders['Authorization']
			.indexOf(`WebPush ${VALID_OUTPUT.unsignedToken}`)
			.should.equal(0);
		authHeaders['Crypto-Key'].should.equal(
			`p256ecdsa=${VALID_OUTPUT.p256ecdsa}`,
		);
	});
});
